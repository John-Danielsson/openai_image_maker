main_context = """
I am inputting written prompts for the DALL-E software application 
o process and generate images from. I would like these prompts to be
improved to the maximum extent possible.
"""

prompt_setup = """
Here is a prompt for DALL-E. Please improve it:
"""

length_restriction = """
This new prompt must be under 1000 characters in length.
Under no circumstances can the prompt be over 1000 characters
in length.
"""

# Credit to Kris from "All About AI" for these strings.
...
But wait, I have more info. Just answer with the word “READ”
"""
...
Range 
any 0–100 .25 .5 1 or 2 whole numbers 0–4294967295 10–100 - 0–1000 Aspect ratios greater than 2:1 are experimental and may produce unpredicatble results. 
But wait, I have more info. Just answer with the word "READ": 
"""
...
image_prompt7 = """
Okay great. would you say you understand how Midjourney works now? Y or N
"""
...
Just answer with the word "READ". 
"""
...
PROMPT_PRIMER = [
    ...
    image_prompt6, image_prompt7,
    image_prompt8, image_prompt9
]